...
//Start - KVMHack - Counter variables initialization
static int cmpe283_exception_nmi = 0;
static int cmpe283_external_interrupt = 0;
...
static int handle_exception(struct kvm_vcpu *vcpu)
{
	...
	//Start - KVMHack - increase counter cmpe283_exception_nmi
	cmpe283_exception_nmi++;
	//End - KVMHack - increase counter cmpe283_exception_nmi
...
{
	//Start - KVMHack - increase counter cmpe283_external_interrupt
	cmpe283_external_interrupt++;
	//End - KVMHack - increase counter cmpe283_external_interrupt
	++vcpu->stat.irq_exits;
	return 1;
}
